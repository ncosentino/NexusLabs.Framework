...
public sealed class TriedNullExTests
{
    ...
    private void Success_ConstructedWithValue_IsTrue()
    {
        ...
        Assert.True(
            tried.Success,
            $"{nameof(tried.Success)} was not expected value.");
        Assert.False(tried.Value, "Value property was not expected value.");
        Assert.Throws<InvalidOperationException>(() => tried.Error);
    }
    ...
    [Fact]
    private void ImplicitConversion_NullValueToTriedReturnTypeInline_ExpectedValue()
    {
        int? value = null;
        TriedNullEx<int?> TryDoSomething() => value;
    ...
    [Fact]
    private void ImplicitConversion_NullValueToTriedReturnTypeSplitLine_ExpectedValue()
    {
        int? value = null;
        TriedNullEx<int?> TryDoSomething() => value;
    ...
    private void Default_Int_0Value()
    {
        ...
        Assert.True(tried.Success, "Default value should indicate success.");
