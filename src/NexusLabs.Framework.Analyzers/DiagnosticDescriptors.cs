...
internal static class DiagnosticDescriptors
{
    ...
    public static readonly DiagnosticDescriptor AsyncMethodMustDeclareCancellationToken = new(
        ...
        messageFormat:
            ...
            "Overrides, interface implementations, `async void` event handlers, `[Fact]`/`[Theory]`/`[Test]` test methods, members named by a test data source attribute such as `[MemberData]`, `Main`, same-named overloads that take a token, and methods with a delegate parameter are already exempt; " +
