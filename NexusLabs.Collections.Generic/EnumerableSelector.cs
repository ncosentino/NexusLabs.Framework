...
{
    private readonly Dictionary<Type, TrySelectRandomDelegate> _cacheTypesToConverter;
    private readonly List<Tuple<MatchCollectionDelegate, TrySelectRandomDelegate>> _mapping;
