...
namespace NexusLabs.Collections.Generic.Tests
{
    ...
    {
        [Fact]
        public void AssumeAsFrozenDictionary_CaseSensitiveStrings_ExpectedEntries()
        {
        ...
        [Fact]
        public void AssumeAsFrozenDictionary_CaseInsensitiveStringsBeforeConversion_ExpectedEntries()
        {
        ...
        [Fact]
        public void AssumeAsFrozenDictionary_CaseInsensitiveStringsBeforeAndAfterConversion_ExpectedEntries()
        {
            Dictionary<string, string> dict = new(StringComparer.OrdinalIgnoreCase)
            {
                ["Key1"] = "Val1",
        ...
        [Fact]
        public void AssumeAsFrozenDictionary_CaseInsensitiveStringsAfterConversion_ExpectedEntries()
        {
            Dictionary<string, string> dict = new()
            {
                ["Key1"] = "Val1",
